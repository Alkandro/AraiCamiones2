...
import firebaseContextHoshinoSabado from "../../context/firebase/Hoshino/FirebaseStateHoshinoSabado/firebaseContextHoshinoSabado";
...
const Hoshino = () => {
  // Context de Firebase
  const { menu, obtenerProductos } = useContext(firebaseContextHoshinoSabado);
  ...
  const categoriaDeseada = 'sabado'; // Cambia esto por la categoría que necesites
