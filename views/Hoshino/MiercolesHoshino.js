...
import firebaseContextHoshinoMiercoles from "../../context/firebase/Hoshino/FirebaseStateHoshinoMiercoles/firebaseContextHoshinoMiercoles";
...
const Hoshino = () => {
  // Context de Firebase
  const { menu, obtenerProductos } = useContext(firebaseContextHoshinoMiercoles);
  ...
  const categoriaDeseada = 'miercoles'; // Cambia esto por la categoría que necesites
