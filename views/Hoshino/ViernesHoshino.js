...
import firebaseContextHoshinoViernes from "../../context/firebase/Hoshino/FirebaseStateHoshinoViernes/firebaseContextHoshinoViernes";
...
const Hoshino = () => {
  // Context de Firebase
  const { menu, obtenerProductos } = useContext(firebaseContextHoshinoViernes);
  ...
  const categoriaDeseada = 'viernes'; // Cambia esto por la categoría que necesites
