...
const DomingoSklar = () => {
  ...
  const menu = getMenu("sklar", "domingo");
  useEffect(() => {
    const unsub = obtenerProductos("sklar", "domingo");
    ...
    <NativeBaseProvider>
      <EnviosList
        ...
        eliminarProductoFirebase={(id) =>
          eliminarProductoFirebase("sklar", "domingo", id)
        }
        obtenerProductos={() => obtenerProductos("sklar", "domingo")}
