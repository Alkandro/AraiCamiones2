...
import FirebaseContextTomaokaMiercoles from "./firebaseContextTomaokaMiercoles";
import { OBTENER_PRODUCTOS_TOMAOKA } from "../../../../types";
import _ from "lodash";


const FirebaseStateTomaokaMiercoles = (props) => {
  // Crear state inicial
  const initialState = {
    menu: [],
  };
...
export default FirebaseStateTomaokaMiercoles;
